...
import com.example.isyaratku.databinding.ActivityDetailGifBinding

class DetailGifActivity : AppCompatActivity() {

    private lateinit var binding: ActivityDetailGifBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityDetailGifBinding.inflate(layoutInflater)
        ...
        val data = intent.getParcelableExtra<Populer>(DetailImageActivity.EXTRA_DATA)
        if (data != null) {
